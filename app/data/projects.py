...
PROJECTS: list[dict[str, Any]] = [
...

    {
        ...
        "full_description": (
            ...
            "to guess it letter by letter before running out of lives. Demonstrates string manipulation, "
            "list operations, and basic control flow in Python."
        ),
        "tech_stack": ["Python"],
    ...
    },
    {
        ...
        "full_description": (
            ...
            "user-defined amount to encrypt or decrypt. Covers string indexing, modular arithmetic, and "
            "function design."
        ),
        "tech_stack": ["Python"],
        "links": {"repo": None, "live": None, "demo": None},
    ...
    },
    {
        ...
        "full_description": (
            ...
            "Implements dealer logic, card drawing, bust detection, and score tracking across multiple rounds. "
            "Demonstrates class design and game state management."
        ),
    ...
    },
    {
        ...
        "full_description": (
            ...
            "within a limited number of attempts. Supports easy and hard difficulty levels with "
            "appropriate attempt counts."
        ),
        "tech_stack": ["Python"],
        "links": {"repo": None, "live": None, "demo": None},
        "media": {"card_image": None, "screenshots": [], "videos": []},
    ...
    },
    {
        ...
        "full_description": (
            ...
            "more followers. Tracks score across consecutive correct answers and ends on the first wrong guess."
        ),
        "tech_stack": ["Python"],
        "links": {"repo": None, "live": None, "demo": None},
        "media": {"card_image": None, "screenshots": [], "videos": []},
    ...
    },
    {
        ...
        "full_description": (
            ...
            "a QuizBrain class manages game state, and results are tracked across rounds. "
            "Demonstrates class design, separation of concerns, and structured data handling."
        ),
        "tech_stack": ["Python", "OOP"],
        "links": {"repo": None, "live": None, "demo": None},
        "media": {"card_image": None, "screenshots": [], "videos": []},
    ...
    },
    {
        ...
        "full_description": (
            ...
            "Features real-time movement, collision detection with walls and the snake's own body, "
            "food spawning, and a score display that increases as the snake grows."
        ),
        "tech_stack": ["Python", "Turtle", "OOP"],
        "links": {"repo": None, "live": None, "demo": None},
        "media": {"card_image": None, "screenshots": [], "videos": []},
        "featured": False,
        "date": "2025-10-12",
    },
    {
        ...
        "full_description": (
            ...
            "Handles keyboard-driven paddle movement, ball bounce physics, boundary detection, "
            "and a live score display. Built with OOP using separate classes for paddles, ball, and scoreboard."
        ),
        "tech_stack": ["Python", "Turtle", "OOP"],
        "links": {"repo": None, "live": None, "demo": None},
        "media": {"card_image": None, "screenshots": [], "videos": []},
    ...
    },
    {
        ...
        "full_description": (
            ...
            "Difficulty increases with each successful crossing as cars speed up. "
            "Built with Turtle graphics and OOP — separate classes for player, car manager, and scoreboard."
        ),
        "tech_stack": ["Python", "Turtle", "OOP"],
        "links": {"repo": None, "live": None, "demo": None},
        "media": {"card_image": None, "screenshots": [], "videos": []},
    ...
    },
    {
        ...
        "full_description": (
            ...
            "has more followers, with score tracked across rounds in the browser. "
            "An early Flask project covering routing, Jinja rendering, and session state."
        ),
...

    {
        ...
        "full_description": (
            ...
            "and coin-based payments. Built with OOP — a CoffeeMaker, Menu, and MoneyMachine class "
            "each handle a distinct responsibility."
        ),
        "tech_stack": ["Python", "OOP"],
        "links": {"repo": None, "live": None, "demo": None},
        "media": {"card_image": None, "screenshots": [], "videos": []},
    ...
    },
    {
        ...
        "full_description": (
            ...
            "An introductory project covering Tkinter layout, event binding, and real-time output updates."
        ),
    ...
    },
    {
        ...
        "full_description": (
            ...
            "followed by short and long breaks, with a visual countdown timer and session tracking. "
            "Demonstrates Tkinter widget management, after() scheduling, and state control."
        ),
        "tech_stack": ["Python", "Tkinter"],
        "links": {"repo": None, "live": None, "demo": None},
        "media": {"card_image": None, "screenshots": [], "videos": []},
    ...
    },
    {
        ...
        "full_description": (
            ...
            "in a local JSON file, and supports searching by website. Covers GUI design, file I/O, "
            "and data persistence without a database."
        ),
        "tech_stack": ["Python", "Tkinter", "JSON"],
        "links": {"repo": None, "live": None, "demo": None},
        "media": {"card_image": None, "screenshots": [], "videos": []},
        "featured": False,
        "date": "2025-11-07",
    },
    {
        ...
        "full_description": (
            ...
            "and removes known words from the active deck. Progress is saved to CSV so the session "
            "picks up where the user left off."
        ),
        "tech_stack": ["Python", "Tkinter", "Pandas", "CSV"],
        "links": {"repo": None, "live": None, "demo": None},
        "media": {"card_image": None, "screenshots": [], "videos": []},
        "featured": False,
        "date": "2025-11-12",
    },
    {
        ...
        "full_description": (
            ...
            "in a styled GUI with score tracking. Combines API integration, OOP design, and GUI development "
            "in a single project."
        ),
        "tech_stack": ["Python", "Tkinter", "Requests", "Open Trivia API"],
        "links": {"repo": None, "live": None, "demo": None},
        "media": {"card_image": None, "screenshots": [], "videos": []},
        "featured": False,
        "date": "2025-11-20",
...

    {
        ...
        "full_description": (
            ...
            "individually addressed letters by substituting each name into the template. "
            "Demonstrates file I/O, string replacement, and automation fundamentals."
        ),
        "tech_stack": ["Python", "File I/O"],
        "links": {"repo": None, "live": None, "demo": None},
        "media": {"card_image": None, "screenshots": [], "videos": []},
        "featured": False,
        "date": "2025-10-25",
    },
    {
        ...
        "full_description": (
            ...
            "and sends a personalised birthday email via smtplib when a match is found. "
            "Demonstrates scheduled automation, datetime handling, and email integration."
        ),
        "tech_stack": ["Python", "smtplib", "Pandas", "datetime"],
        "links": {"repo": None, "live": None, "demo": None},
        "media": {"card_image": None, "screenshots": [], "videos": []},
        "featured": False,
        "date": "2025-11-15",
    },
    {
        ...
        "full_description": (
            ...
            "then sends an email notification when the ISS is overhead and dark enough to see it. "
            "Demonstrates multi-API integration, conditional automation, and scheduled execution."
        ),
        "tech_stack": ["Python", "Requests", "smtplib"],
        "links": {"repo": None, "live": None, "demo": None},
        "media": {"card_image": None, "screenshots": [], "videos": []},
        "featured": False,
        "date": "2025-11-17",
    },
    {
        ...
        "full_description": (
            ...
            "Credentials are managed with environment variables following secure configuration practices. "
            "A foundational automation project used as a building block in later alert systems."
        ),
        "tech_stack": ["Python", "Twilio API"],
        "links": {"repo": None, "live": None, "demo": None},
        "media": {"card_image": None, "screenshots": [], "videos": []},
        "featured": False,
        "date": "2025-11-23",
    },
    {
        ...
        "full_description": (
            ...
            "fetches relevant news headlines from the News API when a significant movement is detected, "
            "and delivers a formatted SMS alert via Twilio. "
    ...
    },
    {
        ...
        "full_description": (
            ...
            "building a visual contribution-graph of streaks over time. "
            "Covers REST API interaction, authentication headers, and structured HTTP request design."
        ),
        "tech_stack": ["Python", "Requests", "Pixela API"],
        "links": {"repo": None, "live": None, "demo": None},
        "media": {"card_image": None, "screenshots": [], "videos": []},
        "featured": False,
        "date": "2025-11-29",
    },
    {
        ...
        "full_description": (
            ...
            "exercise API for interpretation, and logs the structured output — exercise name, duration, "
            "and calories — to a Google Sheets spreadsheet via the Sheety API. "
            "Demonstrates NLP-backed API integration and multi-service data pipelines."
        ),
        "tech_stack": ["Python", "Requests", "Nutritionix API", "Sheety API"],
        "links": {"repo": None, "live": None, "demo": None},
        "media": {"card_image": None, "screenshots": [], "videos": []},
        "featured": False,
        "date": "2025-12-02",
    },
    {
        ...
        "full_description": (
            ...
            "extracts the current price, and sends an email notification via smtplib when it falls below "
            "a user-defined threshold. Combines web scraping and conditional alerting."
        ),
        "tech_stack": ["Python", "BeautifulSoup", "Requests", "smtplib"],
        "links": {"repo": None, "live": None, "demo": None},
        "media": {"card_image": None, "screenshots": [], "videos": []},
        "featured": False,
        "date": "2026-01-02",
    },
    {
        ...
        "full_description": (
            ...
            "site, locates elements by selector, and interacts with forms and buttons programmatically. "
            "A foundational project used as the basis for more complex bots later in the course."
        ),
    ...
    },
    {
        ...
        "full_description": (
            ...
            "predefined gym routine without manual input. Demonstrates login automation, "
            "session handling, and structured interaction with dynamic web content."
        ),
        "tech_stack": ["Python", "Selenium"],
        "links": {"repo": None, "live": None, "demo": None},
        "media": {"card_image": None, "screenshots": [], "videos": []},
    ...
    },
    {
        ...
        "full_description": (
            ...
            "and automated swiping. Demonstrates session handling, dynamic content waiting, "
            "and element targeting in a single-page application."
        ),
        "tech_stack": ["Python", "Selenium"],
        "links": {"repo": None, "live": None, "demo": None},
        "media": {"card_image": None, "screenshots": [], "videos": []},
    ...
    },
    {
        ...
        "full_description": (
            ...
            "contracted speed threshold, and automatically posts a tweet to the ISP if speeds are too low. "
            "Combines API data retrieval with browser automation and conditional action logic."
        ),
        "tech_stack": ["Python", "Selenium", "Speedtest API"],
        "links": {"repo": None, "live": None, "demo": None},
        "media": {"card_image": None, "screenshots": [], "videos": []},
        "featured": False,
        "date": "2026-01-15",
    },
    {
        ...
        "full_description": (
            ...
            "and automates the follow action on each user. Demonstrates handling of modal dialogs, "
            "infinite scroll, and rate-limited interactions in browser automation."
        ),
        "tech_stack": ["Python", "Selenium"],
        "links": {"repo": None, "live": None, "demo": None},
        "media": {"card_image": None, "screenshots": [], "videos": []},
    ...
    },
    {
        ...
        "full_description": (
            ...
            "extracts address, price, and link data, then uses Selenium to fill and submit a Google Form "
            "for each entry. Combines scraping and browser automation in a single workflow."
        ),
        "tech_stack": ["Python", "BeautifulSoup", "Selenium", "Requests"],
        "links": {"repo": None, "live": None, "demo": None},
        "media": {"card_image": None, "screenshots": [], "videos": []},
        "featured": False,
        "date": "2026-01-22",
...

    {
        ...
        "full_description": (
            ...
            "on screen with a styled layout. A simple but complete project combining GUI design with "
            "live API data fetching."
        ),
        "tech_stack": ["Python", "Requests", "Tkinter", "Kanye REST API"],
        "links": {"repo": None, "live": None, "demo": None},
        "media": {"card_image": None, "screenshots": [], "videos": []},
        "featured": False,
        "date": "2025-11-17",
    },
    {
        ...
        "full_description": (
            ...
            "via Sheety, searches for available flights through the Kiwi Tequila API, and sends an SMS "
            "alert via Twilio when a deal is found. "
    ...
    },
    {
        ...
        "full_description": (
            ...
            "BeautifulSoup, then authenticates with the Spotify API via Spotipy to search for each song "
            "and create a time-travel playlist in the user's account. "
            "Combines web scraping with OAuth authentication and API playlist management."
        ),
        "tech_stack": ["Python", "BeautifulSoup", "Spotipy", "Spotify API"],
        "links": {"repo": None, "live": None, "demo": None},
        "media": {"card_image": None, "screenshots": [], "videos": []},
        "featured": False,
        "date": "2025-12-20",
...

    {
        ...
        "full_description": (
            ...
            "dynamically using Jinja2 templates with Bootstrap styling. "
            "Covers Flask routing, Jinja template inheritance, and external API data rendering in a "
            "complete multi-page web application."
        ),
        "tech_stack": ["Python", "Flask", "Jinja2", "Bootstrap", "Requests"],
        "links": {"repo": None, "live": None, "demo": None},
        "media": {"card_image": None, "screenshots": [], "videos": []},
        "featured": False,
        "date": "2026-01-24",
    },
    {
        ...
        "full_description": (
            ...
            "availability, and submit new entries via a WTForms-powered form. "
            "Data is persisted in CSV. An early full-stack project combining Flask routing, form handling, "
            "and file-based storage."
        ),
        "tech_stack": ["Python", "Flask", "WTForms", "Bootstrap", "CSV"],
        "links": {"repo": None, "live": None, "demo": None},
        "media": {"card_image": None, "screenshots": [], "videos": []},
        "featured": False,
        "date": "2026-02-01",
    },
    {
        ...
        "full_description": (
            ...
            "personal top 10 list, and rank and edit them through a database-backed CRUD interface. "
    ...
    },
    {
        ...
        "full_description": (
            ...
            "backed by SQLAlchemy and tested with Postman. "
            "Demonstrates RESTful design principles, HTTP status codes, JSON response formatting, "
            "and API documentation practice."
        ),
        "tech_stack": ["Python", "Flask", "SQLAlchemy", "Postman"],
        "links": {"repo": None, "live": None, "demo": None},
        "media": {"card_image": None, "screenshots": [], "videos": []},
        "featured": False,
        "date": "2026-02-10",
    },
    {
        ...
        "full_description": (
            ...
            "admin-only post creation and deletion, and comment functionality. "
            "Built with SQLAlchemy and PostgreSQL, with relational models linking users, posts, and comments. "
            "The most complete web project before the portfolio site."
        ),
        "tech_stack": ["Python", "Flask", "SQLAlchemy", "PostgreSQL", "WTForms", "Bootstrap"],
        "links": {"repo": None, "live": None, "demo": None},
        "media": {"card_image": None, "screenshots": [], "videos": []},
        "featured": False,
        "date": "2026-02-16",
...

    {
        ...
        "full_description": (
            ...
            "The player names US states one by one, which are plotted on a map as they're guessed correctly. "
            "At the end, a CSV of missed states is generated for further study. "
            "Combines data lookup with GUI interaction."
        ),
        "tech_stack": ["Python", "Pandas", "Turtle", "CSV"],
        "links": {"repo": None, "live": None, "demo": None},
        "media": {"card_image": None, "screenshots": [], "videos": []},
        "featured": False,
        "date": "2025-10-27",
    },
    {
        ...
        "full_description": (
            ...
            "Uses Pandas for sorting, filtering, and grouping, and Matplotlib for visualisation. "
            "Surfaces which majors lead to the highest earning potential at different career stages."
        ),
    ...
    },
    {
        ...
        "full_description": (
            ...
            "the relative popularity of programming languages over the years. "
            "Applies Pandas for reshaping and aggregation, and Matplotlib for multi-line trend charts."
        ),
        "tech_stack": ["Python", "Pandas", "Matplotlib"],
        "links": {"repo": None, "live": None, "demo": None},
        "media": {"card_image": None, "screenshots": [], "videos": []},
    ...
    },
    {
        ...
        "full_description": (
            ...
            "and colours. Uses merge operations across multiple related tables to answer questions about "
            "how LEGO sets have evolved over time, visualised with Matplotlib."
        ),
        "tech_stack": ["Python", "Pandas", "Matplotlib"],
        "links": {"repo": None, "live": None, "demo": None},
        "media": {"card_image": None, "screenshots": [], "videos": []},
    ...
    },
    {
        ...
        "full_description": (
            ...
            "Uses Pandas for date parsing, resampling, and rolling averages, and Matplotlib for "
            "multi-series trend visualisation. Demonstrates temporal data handling and pattern extraction."
        ),
        "tech_stack": ["Python", "Pandas", "Matplotlib"],
        "links": {"repo": None, "live": None, "demo": None},
        "media": {"card_image": None, "screenshots": [], "videos": []},
    ...
    },
    {
        ...
        "full_description": (
            ...
            "patterns, install counts, and pricing strategies across different app types. "
            "Uses Pandas for cleaning and aggregation, and Plotly for interactive charts."
        ),
    ...
    },
    {
        ...
        "full_description": (
            ...
            "reshaping, and mathematical operations on multi-dimensional data. "
            "Foundational work for the machine learning projects that follow."
        ),
    ...
    },
    {
        ...
        "full_description": (
            ...
            "relationships between variables. Uses Seaborn for correlation plots and regression visualisation, "
            "and scikit-learn for model fitting. An introduction to predictive modelling methodology."
        ),
        "tech_stack": ["Python", "Pandas", "Seaborn", "scikit-learn"],
        "links": {"repo": None, "live": None, "demo": None},
        "media": {"card_image": None, "screenshots": [], "videos": []},
        "featured": False,
        "date": "2026-03-06",
    },
    {
        ...
        "full_description": (
            ...
            "Explores trends by country, gender, age, and prize category using Pandas for aggregation "
    ...
    },
    {
        ...
        "full_description": (
            ...
            "linking handwashing to reduced patient mortality. Uses Pandas for data preparation and "
            "Matplotlib and Seaborn to visualise the dramatic reduction in death rates after the intervention."
        ),
...

    {
        ...
        "full_description": (
            ...
            "Covers the full ML pipeline: data cleaning, feature engineering, train/test splitting, "
            "model training with scikit-learn, and evaluation using RMSE and R² metrics, "
...

    {
        ...
        "full_description": (
            ...
            "modular design, and well-documented code. Demonstrates Python scripting fundamentals "
            "including file handling, automation logic, and reusable function design."
        ),
        "tech_stack": ["Python"],
        "links": {"repo": None, "live": None, "demo": None},
        "media": {"card_image": None, "screenshots": [], "videos": []},
...

    {
        ...
        "full_description": (
            ...
            "Features a PostgreSQL database with SQLAlchemy ORM, dynamic project rendering, reusable Jinja "
            "components, Bootstrap layout, contact form with email delivery, Google Analytics, SEO metadata, "
